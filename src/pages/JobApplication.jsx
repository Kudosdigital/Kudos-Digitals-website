    ...
    return (
        <div className="bg-[#001515] text-[#AAD468]">
            ...
            <div className="">
                ...
                <form ref={form} onSubmit={handleSubmit} className="py-10 lg:px-20 px-5">
                    <input type="hidden" name="job_title" value={job.title} /> {/* Hidden field for job title */}
                    ...
                    <div className="w-full bg-gradient-to-br from-[#1b2b2b] to-[#2c3c3c] rounded-xl px-4 my-5 py-2 border border-gray-500 flex items-center">
                        <label className="text-[#aad468] font-semibold mr-2 text-xl">Full Name:</label>
                        <input type="text" name="full_name" className="bg-transparent text-white outline-none min-w-[60%]" required />
                    </div>
                    <div className="w-full bg-gradient-to-br from-[#1b2b2b] to-[#2c3c3c] rounded-xl px-4 my-5 py-2 border border-gray-500 flex items-center">
                        <label className="text-[#aad468] font-semibold mr-2 text-xl">Email:</label>
                        <input type="email" name="applicant_email" className="bg-transparent text-white outline-none min-w-[60%]" required />
                    </div>
                    <div className="w-full bg-gradient-to-br from-[#1b2b2b] to-[#2c3c3c] rounded-xl px-4 my-5 py-2 border border-gray-500 flex items-center">
                        <label className="text-[#aad468] font-semibold mr-2 text-xl">Phone Number:</label>
                        <input type="tel" name="phone_number" className="bg-transparent text-white outline-none" required />
                    </div>
                    <div className="w-full bg-gradient-to-br from-[#1b2b2b] to-[#2c3c3c] rounded-xl px-4 my-5 py-2 border border-gray-500 flex items-center">
                        <label className="text-[#aad468] font-semibold mr-2 text-xl">LinkedIn Profile URL(Optional):</label>
                        <input type="url" name="linkedin_profile" className="bg-transparent text-white outline-none min-w-[60%]" />
                    </div>
                    <div className="w-full bg-gradient-to-br from-[#1b2b2b] to-[#2c3c3c] rounded-xl px-4 my-5 py-2 border border-gray-500 flex items-center">
                        <label className="text-[#aad468] font-semibold mr-2 text-xl">Portfolio Link:</label>
                        <input type="url" name="portfolio_link" className="bg-transparent text-white outline-none min-w-[60%]" />
                    </div>
                    ...
                    <div className="w-full bg-gradient-to-br from-[#1b2b2b] to-[#2c3c3c] rounded-xl px-4 my-5 py-2 border border-gray-500">
                        <div className="flex items-center">
                            <label className="text-[#aad468] font-semibold mr-2 text-xl">Cover Letter (Optional):</label>
                    ...
                    <div className="w-full flex justify-between bg-gradient-to-br from-[#1b2b2b] to-[#2c3c3c] rounded-xl px-4 my-5 py-2 border border-gray-500 items-center">
                        <div className="flex items-center">
                            <label className="text-[#aad468] font-semibold mr-2 text-xl">CV Upload:</label>
                    ...
                    {submissionStatus === 'success' && (
                        <p className="text-green-500 text-center text-xl mt-4">Application submitted successfully!</p>
                    )}
                    {submissionStatus === 'error' && (
                        <p className="text-red-500 text-center text-xl mt-4">Failed to submit application. Please try again.</p>
                    )}
                </form>
