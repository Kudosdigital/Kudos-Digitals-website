    ...
    <main className="text-[#001C1C]">
        ...
        <div className="flex flex-col md:flex-row max-w-7xl mx-auto gap-10 items-center">
          ...
          <div className="space-y-6 md:text-lg leading-relaxed md:w-1/2 text-center md:text-start">
            <p>
              ...
              in Lagos, Nigeria, with a talented remote team across the nation.
            </p>
            <p>
      ...
      >
        ...
        <div className="flex flex-col-reverse md:flex-row max-w-7xl mx-auto gap-10 items-center">
          <div className="space-y-6 md:text-lg leading-relaxed md:w-1/2 text-center md:text-start">
            ...
            <button className="px-8 py-3 rounded-lg bg-[#001C1C] hover:bg-[#262727] text-[#C6E29A] transition">
              Share Your Idea
            </button>
          </div>
          <img
      ...
      >
        ...
        <div className="mt-24 text-center">
          ...
          <button className="mt-2 px-6 py-3 bg-[#001C1C] hover:bg-[#262727] text-[#C6E29A] text-base sm:text-lg rounded-lg transition">
            Talk to us today
          </button>
        </div>
      </section>
