    ...
    <section className="relative w-full" aria-label="Customer testimonials">
      ...
      <div className="relative w-full  mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="relative z-10 rounded-3xl px-4 sm:px-6 md:px-10 lg:px-[106px] py-14 sm:py-20 text-center max-w-full">
          <div ref={testimonialRef} className="mx-auto max-w-3xl px-2 sm:px-4">
            <blockquote>
          ...
          <div className="flex justify-center gap-3 mt-10 sm:mt-12">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-lime-400/50 ${
                  index === currentIndex
          ...
          <div className="absolute -bottom-6 right-21 sm:-bottom-8 sm:right-4 lg:right-16 lg:-bottom-14 flex gap-6 z-20">
            <button
              onClick={prevTestimonial}
              className="w-12 h-12 sm:w-18 sm:h-18 bg-lime-400 hover:bg-lime-300 rounded-full flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-lime-400/50 group"
      ...
      <div className="py-20 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="bg-lime-400 hover:bg-lime-300 text-slate-900 font-bold text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-5 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-4 focus:ring-lime-400/50">
            Share your idea
          </button>
        </div>
      </div>
